package com.project.organ_vlasti.config;

import com.project.organ_vlasti.security.TokenUtils;
import com.project.organ_vlasti.security.auth.RestAuthenticationEntryPoint;
import com.project.organ_vlasti.security.auth.TokenAuthenticationFilter;
import com.project.organ_vlasti.service.CustomUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/auth/**", "/ws/**", "/obavestenje/toPdf/{broj}", "/zahtev/toPdf/{broj}","/resenje/download/{broj}").permitAll()
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html",
                "/**/*.css", "/**/*.js", "/ws/**", "/obavestenje/toPdf/{broj}", "/zahtev/toPdf/{broj}","/resenje/download/{broj}");
    }
}
