...
public class ObjectFactory {
    ...
    private final static QName _TopisBold_QNAME = new QName("http://www.reusability", "bold");
    private final static QName _TopisItalic_QNAME = new QName("http://www.reusability", "italic");
    ...
    public JAXBElement<String> createTopisBold(String value) {
        return new JAXBElement<String>(_TopisBold_QNAME, String.class, Topis.class, value);
    }
    ...
    public JAXBElement<String> createTopisItalic(String value) {
        return new JAXBElement<String>(_TopisItalic_QNAME, String.class, Topis.class, value);
    }
    ...
    public JAXBElement<Topis> createTtekstZahtevaObavestenjaOpisTrazeneInformacije(Topis value) {
        return new JAXBElement<Topis>(_TtekstZahtevaObavestenjaOpisTrazeneInformacije_QNAME, Topis.class, TtekstZahtevaObavestenja.class, value);
    }
    ...
    public JAXBElement<Topis> createTtekstZahtevaZahtevcirInformacijaOZahtevu(Topis value) {
        return new JAXBElement<Topis>(_TtekstZahtevaZahtevcirInformacijaOZahtevu_QNAME, Topis.class, TtekstZahtevaZahtevcir.class, value);
    }
