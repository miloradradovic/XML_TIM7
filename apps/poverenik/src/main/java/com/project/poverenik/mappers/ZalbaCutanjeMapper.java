...
public class ZalbaCutanjeMapper {
	...
	public static ZalbaCutanje mapFromDTO(ZalbaCutanje zalbaCutanjeDTO, String id, String userEmail) {
        ...
        zalbaCutanje.getZalbaCutanjeBody().getSadrzajZalbe().getContent().set(5, (JAXBElement<Topcije>) zalbaCutanjeDTO.getZalbaCutanjeBody().getSadrzajZalbe().getContent().get(5));
        ...
        zalbaCutanje.getZalbaCutanjeBody().getSadrzajZalbe().getContent().set(7, (JAXBElement<XMLGregorianCalendar>) zalbaCutanjeDTO.getZalbaCutanjeBody().getSadrzajZalbe().getContent().get(7));
        ...
        zalbaCutanje.getZalbaCutanjeBody().getSadrzajZalbe().getContent().set(9, (JAXBElement<String>) zalbaCutanjeDTO.getZalbaCutanjeBody().getSadrzajZalbe().getContent().get(9));
