...
public class TtekstZahtevaObavestenja {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "godina", type = JAXBElement.class),
        @XmlElementRef(name = "vreme", type = JAXBElement.class),
        @XmlElementRef(name = "broj_kancelarije", type = JAXBElement.class),
        @XmlElementRef(name = "radno_vreme", type = JAXBElement.class),
        @XmlElementRef(name = "opis_troskova", type = JAXBElement.class),
        @XmlElementRef(name = "opis_trazene_informacije", type = JAXBElement.class),
        @XmlElementRef(name = "ukupan_trosak", type = JAXBElement.class),
        @XmlElementRef(name = "clan", type = JAXBElement.class),
        @XmlElementRef(name = "dan", type = JAXBElement.class)
    })
    @XmlMixed
