...
@WebService(
                      ...
                      endpointInterface = "com.project.poverenik.wsdl.file.FileServicePortType")
@Service
public class FileServiceSoapBindingImpl implements FileServicePortType {
    ...
    public Tpath sendRdfFile(String id) {
        ...
        try {
            ...
            String path = resenjeService.generateRdf(id);
    ...
    public Tpath sendJsonFile(String id) {
        ...
        try {
            ...
            String path = resenjeService.generateJson(id);
