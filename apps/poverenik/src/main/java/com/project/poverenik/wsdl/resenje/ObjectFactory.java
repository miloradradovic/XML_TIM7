...
public class ObjectFactory {
    ...
    private final static QName _Resenje_QNAME = new QName("http://resenje", "resenje");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://resenje", name = "resenje")
    ...
    public JAXBElement<Tadresa.Mesto> createTadresaMesto(Tadresa.Mesto value) {
        return new JAXBElement<Tadresa.Mesto>(_TodlukaMesto_QNAME, Tadresa.Mesto.class, Tadresa.class, value);
    }
    ...
    public JAXBElement<TuvodneInformacije.Lice> createTuvodneInformacijeLice(TuvodneInformacije.Lice value) {
        return new JAXBElement<TuvodneInformacije.Lice>(_TodlukaLice_QNAME, TuvodneInformacije.Lice.class, TuvodneInformacije.class, value);
    }
