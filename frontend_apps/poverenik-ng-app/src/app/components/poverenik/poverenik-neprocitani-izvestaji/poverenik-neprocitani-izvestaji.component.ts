...
@Component({
  selector: 'app-poverenik-neprocitani-izvestaji',
  templateUrl: './poverenik-neprocitani-izvestaji.component.html',
  styleUrls: ['./poverenik-neprocitani-izvestaji.component.css']
})
export class PoverenikNeprocitaniIzvestajiComponent implements OnInit {
  izvestaji = [];
  form: FormGroup;
  ...
  ngOnInit(): void {
    const newList = [];
    this.izvestajService.getIzvestajListByStatus('ne').subscribe(
      result => {
        // @ts-ignore
